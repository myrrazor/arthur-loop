# ChatGPT Plan Approval Review Placeholder

```text
Arthur Loop plan approval review for {{PROJECT_ID}}.

Please review the Codex-generated plan below. Approve it only if it satisfies the prior ChatGPT instruction, preserves all stop conditions, and has no unresolved P0/P1 concerns.
